...
\caption{Sprint 3 backlog in Jira showing owners and completion status.}
...
\caption{Stage 1 dashboard for exploring per-agent margin thresholds.}
...
\caption{Sprint 3 retrospective feedback board in Miro.}
...
\caption{Sprint 3 retrospective action items for Sprint 4.}
