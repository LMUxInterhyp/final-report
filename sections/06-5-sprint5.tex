...
\caption{Sprint 5 backlog in Jira showing owners and completion status.}\label{fig:sprint5-backlog}
\end{figure}
...
\caption{PropDesk deployment architecture across the identity, frontend, backend, and worker layers.}\label{fig:sprint5-architecture}
\end{figure}
