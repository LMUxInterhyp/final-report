\subsection{Sprint 5}\label{sec:sprint5}
...
\caption{Sprint 5 backlog in Jira with owners and completion status.}\label{fig:sprint5-backlog}
\end{figure}
...
\begin{figure}
\centering
\includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio]{assets/sprints/sprint5-deployment-architecture.png}
\caption{Deployment architecture of PropDesk across identity, frontend, backend, and worker layers.}\label{fig:sprint5-architecture}
\end{figure}
