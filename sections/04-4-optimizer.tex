...
\caption{Optimization dashboard for the run of 24 June 2026 (own illustration).}\label{fig:optimization-dashboard}
\end{figure}
...
\caption{Champion accuracy by agent under both labelings. Case counts differ because the judge and the golden dataset assign some queries to different agents (own illustration).}\label{tbl:optimizer-champion}\tabularnewline
\toprule\noalign{}
